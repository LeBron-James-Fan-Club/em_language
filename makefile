...
$(OBJDIR)/comp.o: $(SRCDIR)/comp.c $(INCDIR)/comp.h $(INCDIR)/context.h
	mkdir -p $(OBJDIR)
	$(CC) $(CFLAGS) -c $(SRCDIR)/comp.c -o $@

# Rule to compile asm.c
$(OBJDIR)/asm.o: $(SRCDIR)/asm.c $(INCDIR)/asm.h $(INCDIR)/context.h
	mkdir -p $(OBJDIR)
	$(CC) $(CFLAGS) -c $(SRCDIR)/asm.c -o $@

# Rule to compile types.c
$(OBJDIR)/types.o: $(SRCDIR)/types.c $(INCDIR)/types.h $(INCDIR)/context.h
	mkdir -p $(OBJDIR)
